...
public class DocumentCollection {
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.numDocuments() - 1; i++) {
            res.append(this.get(i).getTitle()).append(", ");
        }
        res.append(this.get(this.numDocuments() - 1).getTitle()).append("]");
        return res.toString();
    }
     ...
     * <p>
     * If the word is contained in the {@link WordCountsArray} of a {@link Document}
