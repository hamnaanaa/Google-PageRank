...
public class LinkedDocumentCollection extends DocumentCollection {
     ...
     * @return the positions within this collection of the documents pointing to this document at the given index position
     */
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.numDocuments() - 1; i++) {
            res.append(((LinkedDocument) this.get(i)).getID()).append(", ");
        }
        res.append(((LinkedDocument) this.get(this.numDocuments() - 1)).getID()).append("]");
        return res.toString();
    }
